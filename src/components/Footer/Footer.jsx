    ...
    <footer className="footer-container">
      <div className="footer-content">
        ...
        <div className="contact-section">
          <img src={assets.logo} alt="BIMT Institute" className="footer-logo" />
          ...
          <p className="footer-text">
            ...
            <a href="mailto:admissions@futureuniversity.in" className='admissionLink'>
        ...
        <div className="footer-social-media">
          ...
          <div className="footer-social-icons">
            <a href="https://www.facebook.com/BIMTcollegebudaun/" target='blank' className="footer-social-icon">
              <i className="fab fa-facebook"></i>
            </a>
            <a href="https://www.instagram.com/b.i.m.t._badaun/" target='blank' className="footer-social-icon">
              <i className="fab fa-instagram"></i>
            </a>
            <a href="https://www.linkedin.com/school/budaun-institute-of-management-&-technology/about/" target='blank' className="footer-social-icon">
              <i className="fab fa-linkedin"></i>
            </a>
            <a href="https://www.youtube.com/@bimtlivenow1229" target='blank' className="footer-social-icon">
      ...
      <div className="footer-bottom">
        <p>© 2025 All rights reserved. Developed by Praveen.</p>
      </div>
    </footer>
    </>
